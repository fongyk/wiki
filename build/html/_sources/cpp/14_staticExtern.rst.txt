...
.. note::
  ...
  `Static variables are local to the compilation unit <https://stackoverflow.com/a/5040577>`_ . A compilation unit is basically a ``.cpp`` file with the contents of the ``.h`` file inserted in place of each ``#include`` directive.
