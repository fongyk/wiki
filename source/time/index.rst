...
.. raw:: html
    ...
    <head>
        ...
        <style>
            ...
            .minutehand{width:36.5%;height:2px;background-color:grey;transform-origin:0%;z-index:21;position:absolute;top:49.8%;left:50%;border-radius:1px;box-shadow:1px -3px 8px 1px #aaa;}
