...
.. raw:: html
    ...
    <body>
        ...
        <p style="text-align:center;">
            <input type="text" style="border:1px solid rgba(0, 0, 0, 0.1);text-align:center;background:transparent;color:#830303;margin:0 auto;width:360px;font-size:30px;border-radius:10px;" oninput="setInput(event)" id="endTime" placeholder="2000-01-01 00:00:00">
        </p>
